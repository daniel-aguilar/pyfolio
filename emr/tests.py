...
class PatientTestCase(TestCase):
    def test_calculate_age(self):
        patient = baker.make(Patient, date_of_birth=date(1994, 3, 16))
        self.assertEqual(patient.age(), 23)

    def test_invalid_date_of_birth(self):
        patient = baker.make(Patient, date_of_birth=date(2017, 11, 26))
        ...
        self.assertDictEqual(
            the_exception.message_dict, {"date_of_birth": [_("Invalid date of birth.")]}
        )
